...
<script type="text/javascript">
    ...
    function drawChart1() {
        ...
        var chart = new google.visualization.ColumnChart(document.getElementById("resume_chart"));
...
<script type="text/javascript">
  ...
  function drawChart2() {
    ...
    var chart = new google.visualization.ColumnChart(document.getElementById("interview_chart"));
